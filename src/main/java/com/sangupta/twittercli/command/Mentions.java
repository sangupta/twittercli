...
@Command(name = "mentions", description = "Show 20 recent mentions for the current user")
public class Mentions extends TwitterCommand {

	@Override
	public void doCommand() {
		WebRequest request = WebInvoker.getWebRequest("https://api.twitter.com/1.1/statuses/mentions_timeline.json", WebRequestMethod.GET);
